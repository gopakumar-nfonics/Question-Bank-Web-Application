...
<head>
	...
	<link href="{{ url('/') }}/assets/plugins/custom/bootstrap-datepicker/bootstrap-datepicker.min599c.css?v4.0.2" rel="stylesheet" type="text/css" />
				...
				<div class="app-container container-fluid d-flex align-items-stretch justify-content-between" id="kt_app_header_container">
					...
					<div class="d-flex align-items-center flex-grow-1 flex-lg-grow-0">
						<a href="" class="d-lg-none">
							<img alt="Logo" src="{{ isset(Auth::user()->personalInformation->image_path) && !empty(Auth::user()->personalInformation->image_path) ? asset('storage/images/' . Auth::user()->personalInformation->image_path) : asset('assets/images/user-thumb.jpg') }}" class="h-30px" />
						</a>
					</div>
					<!--end::Mobile logo-->
										...
										<div class="menu-content d-flex align-items-center px-3">
											...
											<div class="d-flex flex-column">
												<div class="fw-bold d-flex align-items-center fs-5">{{ Auth::user()->first_name }} @if(Auth::user()->last_name){{ Auth::user()->last_name }}@endif
													<span class="badge badge-light-success fw-bold fs-8 px-2 py-1 ms-2" style="text-transform: capitalize">{{Auth::user()->role}}</span>
												</div>
					...
					<div class="app-sidebar-menu overflow-hidden flex-column-fluid">
						...
						<div id="kt_app_sidebar_menu_wrapper" class="app-sidebar-wrapper hover-scroll-overlay-y my-5" data-kt-scroll="true" data-kt-scroll-activate="true" data-kt-scroll-height="auto" data-kt-scroll-dependencies="#kt_app_sidebar_logo, #kt_app_sidebar_footer" data-kt-scroll-wrappers="#kt_app_sidebar_menu" data-kt-scroll-offset="5px" data-kt-scroll-save-state="true">
							...
							<div class="menu menu-column menu-rounded menu-sub-indention px-3" id="#kt_app_sidebar_menu" data-kt-menu="true" data-kt-menu-expand="false">
								...
								<div data-kt-menu-trigger="click" class="menu-item menu-accordion @if(in_array(Route::currentRouteName(),array('topic.index','topic.create','topic.edit'))) show @endif">
									<!--begin:Menu link-->
									<span class="menu-link">
										<span class="menu-icon">
											<i class="fa-solid fa-layer-group f-15 p-0"></i>
									...
									<div class="menu-sub menu-sub-accordion">
										...
										<div class="menu-item">
											<!--begin:Menu link-->
											<a class="menu-link @if(in_array(Route::currentRouteName(),array('topic.index'))) active  @endif" href="{{route('topic.index')}}">
												<span class="menu-bullet">
													<span class="bullet bullet-dot"></span>
												</span>
										...
										<div class="menu-item">
											<!--begin:Menu link-->
											<a class="menu-link @if(in_array(Route::currentRouteName(),array('topic.create'))) active  @endif" href="{{route('topic.create')}}">
												<span class="menu-bullet">
													<span class="bullet bullet-dot"></span>
												</span>
