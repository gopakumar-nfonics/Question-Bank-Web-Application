								...
								<div class="row mb-6">
									...
									<!--end::Label-->
											...
											<div class="col-lg-8 fv-row">
												<input type="text" name="name" class="form-control form-control-lg form-control-solid mb-3 mb-lg-0 @error('name') is-invalid @enderror" placeholder="Name" value="{{ old('name') }}" />
								...
								<div class="row mb-6">
									...
									<div class="col-lg-8 fv-row">
										<select name="role" aria-label="Select a Role" class="form-select form-select-solid form-select-lg fw-semibold @error('role') is-invalid @enderror">
											...
											<option value="Question Paper Manager">Question Paper Manager</option>
										</select>
